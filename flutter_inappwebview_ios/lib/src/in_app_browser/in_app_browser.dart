...
class IOSInAppBrowser extends PlatformInAppBrowser with ChannelController {
  ...
  @override
  Future<void> setCloseButton({
    String? title,
    String? text,
    String? confirmText,
    String? cancleText,
    String? isRotationRight,
  }) async {
    // this.throwIsNotOpened();
    Map<String, dynamic> args = <String, dynamic>{};
    args.putIfAbsent('title', () => title);
    args.putIfAbsent('text', () => text);
    args.putIfAbsent('confirmText', () => confirmText);
    args.putIfAbsent('cancleText', () => cancleText);
    args.putIfAbsent('isRotationRight', () => isRotationRight);
    await channel?.invokeMethod('setCloseButton', args);
  }

  @override
  Future<void> updateWebViewLayout({required bool isLandscape}) async {
    Map<String, dynamic> args = <String, dynamic>{};
    args.putIfAbsent('isLandscape', () => isLandscape);
    await channel?.invokeMethod('updateWebViewLayout', args);
  }
