...
class InAppBrowserSettings
  ...
  ///初始化外跳窗口横竖屏 PortraitUp,PortraitDown,LandscapeLeft,LandscapeRight
  ...
  InAppBrowserSettings({
    ...
    this.windowType,
    this.faceOrientation = 'PortraitUp',
    this.isCutTopButtom = false,
  });
  ...
  static InAppBrowserSettings? fromMap(Map<String, dynamic>? map) {
    ...
    instance.faceOrientation = map['faceOrientation'];
    instance.isCutTopButtom = map['isCutTopButtom'];
