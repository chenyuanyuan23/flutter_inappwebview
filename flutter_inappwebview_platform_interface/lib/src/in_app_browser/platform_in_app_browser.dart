...
abstract class PlatformInAppBrowser extends PlatformInterface
  ...
  Future<void> setCloseButton({
    ...
    throw UnimplementedError('setCloseButton is not implemented on the current platform');
  }

  /// 更新 WebView 布局和小球位置（根据屏幕方向变化）
  Future<void> updateWebViewLayout({required bool isLandscape}) {
    throw UnimplementedError('updateWebViewLayout is not implemented on the current platform');
  }
